...
const LogIn = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#edf7e7] flex items-center justify-center px-4 select-none">
      ...
      {/* Background Blobs - Staggered pulse animations for a dynamic feel */}
      ...
      {/* Glass Card - Added layout entrance slide and scale */}
      <div className="relative w-full max-w-md backdrop-blur-xl bg-white/40 border border-white/60 rounded-[40px] shadow-2xl p-10 animate-in fade-in slide-in-from-bottom-6 zoom-in-95 duration-500 ease-out">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          {/* Email Input - Interactive hover lift & clean border transition */}
          ...
          {/* Password Input Container - Interactive hover lift */}
          <div className="relative flex items-center group">
            ...
            {/* Eye Icon Button - Click compression physics */}
            <button
              type="button"
          ...
          {/* Submit Button - Hover pop and click depth micro-interactions */}
          <button
            type="submit"
